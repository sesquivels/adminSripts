...
userName=$(find . -type f -name "logger-*" -o -name "logger_*" | xargs grep curr_user | head -n 1 | cut -c 33-)
...
installPath=$(find . -name logger_wizard.log | xargs grep "Arcsight home" | head -n 1| cut -c 22-)
